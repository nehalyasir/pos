...
class Products extends MY_Controller
{
    ...
    public function add()
    {
       ...
       $this->form_validation->set_rules('code', lang('product_code'), 'trim|is_unique[products.code]|min_length[2]|max_length[50]|required');
    ...
    public function edit($id = null)
    {
        ...
        if ($this->form_validation->run() == true && $this->products_model->updateProduct($id, $data, $store_quantities, $items, $photo)) {
            ...
            $bc                              = [['link' => site_url('products'), 'page' => lang('products')], ['link' => '#', 'page' => lang('edit_product')]];
